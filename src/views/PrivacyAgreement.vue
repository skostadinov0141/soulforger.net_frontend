<template>
	<div class="pa-16 ma-16 text-secondary">
		...
		<p>
			...
			dies zur Erf&uuml;llung seiner Leistungspflichten erforderlich ist und unsere
		...
		<p>
			...
			1 DSGVO verarbeitet werden. Im Falle einer ausdr&uuml;cklichen Einwilligung
			in die &Uuml;bertragung personenbezogener Daten in Drittstaaten erfolgt die
		...
		<p>
			...
			externen Stellen zusammen. Dabei ist teilweise auch eine &Uuml;bermittlung
			von personenbezogenen Daten an diese externen Stellen erforderlich. Wir geben
			personenbezogene Daten nur dann an externe Stellen weiter, wenn dies im
			Rahmen einer Vertragserf&uuml;llung erforderlich ist, wenn wir gesetzlich
			hierzu verpflichtet sind (z.&nbsp;B. Weitergabe von Daten an
			Steuerbeh&ouml;rden), wenn wir ein berechtigtes Interesse nach Art. 6 Abs. 1
			lit. f DSGVO an der Weitergabe haben oder wenn eine sonstige Rechtsgrundlage
		...
		<p>
			...
			ODER VERTEIDIGUNG VON RECHTSANSPR&Uuml;CHEN (WIDERSPRUCH NACH ART. 21 ABS. 1
			DSGVO).
		</p>
		<p>
		...
		<p>
			...
			aush&auml;ndigen zu lassen. Sofern Sie die direkte &Uuml;bertragung der Daten
